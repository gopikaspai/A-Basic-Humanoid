...
#define BS_IOPINS0_0_VAL ((const uint8 CYFAR *)0x480007C8u)
...
#define BS_IOPINS0_2_VAL ((const uint8 CYFAR *)0x480007E0u)

/* IOPINS0_3 Address: CYREG_PRT3_DM0 Size (bytes): 8 */
#define BS_IOPINS0_3_VAL ((const uint8 CYFAR *)0x480007E8u)
...
static void ClockSetup(void)
{
	...
	CY_SET_XTND_REG16((void CYFAR *)(CYREG_CLKDIST_DCFG7_CFG0), 0x0007u);
